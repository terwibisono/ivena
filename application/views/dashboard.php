        ...
        <div class="panel panel-info">
            <div class="panel-body latestStuffsBody" style="background-color: #5cb85c">
                ...
                <div class="pull-right">
                    ...
                    <div class="latestStuffsText">Total Quantity Out</div>
                </div>
            </div>
            <div class="panel-footer text-center" style="color:#5cb85c">Total Quantity Out</div>
        </div>
    </div>
    <div class="col-sm-4">
        <div class="panel panel-info">
            <div class="panel-body latestStuffsBody" style="background-color: #f0ad4e">
                ...
                <div class="pull-right">
                    ...
                    <div class="latestStuffsText pull-right">Total Transaction</div>
                </div>
            </div>
            <div class="panel-footer text-center" style="color:#f0ad4e">Total Transaction</div>
        </div>
    </div>
    <div class="col-sm-4">
        <div class="panel panel-info">
            <div class="panel-body latestStuffsBody" style="background-color: #800">
                <div class="pull-left"><i class="fa fa-shopping-cart"></i></div>
                <div class="pull-right">
                    <div><?=$totalItems?></div>
                    <div class="latestStuffsText pull-right">Item Stock</div>
                </div>
            </div>
...
<div class="row margin-top-5">
    <div class="col-sm-9">
        <div class="box">
            ...
            <div class="box-body" style="background-color:/*#33c9dd*/#800;">
   ...
   <!--  <div class="col-sm-3">
        ...
        <section class="panel">
          <center>
              <canvas id="paymentMethodChart" width="200" height="200"/></canvas><br>Stock Methods(%)<span id="paymentMethodYear"></span>
          </center>
        </section>
    </div>
</div> -->
