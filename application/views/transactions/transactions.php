                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="row">
                                        <!-- <div class="col-sm-3 form-group-sm"> -->
                                            ...
                                            <input type="hidden" min="0" id="vat" class="form-control" value="0">
                                        <!-- </div> -->
                                        
                                        <!-- <div class="col-sm-3 form-group-sm"> -->
                                            <!-- <label for="discount">Discount(%)</label> -->
                                            <input type="hidden" min="0" id="discount" class="form-control" value="0">
                                        <!-- </div> -->
                                        
                                        <!-- <div class="col-sm-3 form-group-sm"> -->
                                            <!-- <label for="discount">Discount(value)</label> -->
                                            <input type="hidden" min="0" id="discountValue" class="form-control" value="0">
                                        <!-- </div> -->
                                        
                                        <div class="col-sm-3 form-group-sm">
                                            <label for="modeOfPayment">EMPLOYMENT STATUS</label>
                                            <select class="form-control checkField" id="modeOfPayment">
                                                <option value="">---</option>
                                                <option value="Pegawai">Pegawai</option>
                                                <option value="NonPegawai">Non Pegawai</option>
                                                <!-- <option value="Non Pegawai By Memo">Non Pegawai By Memo</option> -->
                                            </select>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4 form-group-sm">
                                            ...
                                            <span id="cumAmount" class="form-control">0</span>
                                        </div>
                                        ...
                                        <div class="col-sm-4 form-group-sm">
                                            ...
                                            <div id="amountTenderedDiv">
                                                <label for="amountTendered" id="amountTenderedLabel">Charge If Lost</label>
                                                <input type="text" class="form-control" id="amountTendered">
                                                <span class="help-block errMsg" id="amountTendered"></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4 form-group-sm">
                                            <label for="custName">Receiver</label>
                                            <input type="text" id="custName" class="form-control" placeholder="Receiver">
                                        </div>
                                        
                                        <div class="col-sm-4 form-group-sm">
                                            <label for="custPhone">NIK</label>
                                            <input type="tel" id="custPhone" class="form-control" placeholder="NIK">
                                        </div>
                                        
                                        <div class="col-sm-4 form-group-sm">
                                            <label for="custEmail">Unit</label>
                                            <input type="email" id="custEmail" class="form-control" placeholder="Unit">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="row hidden" id="divToClone">
    ...
    <div class="col-sm-2 form-group-sm">
        <label>Unit </label>
        <span class="form-control itemUnitPrice">0</span>
    </div>
